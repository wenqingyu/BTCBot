...
class BTCChina():
    def __init__(self,access=None,secret=None,tradeType=None):
    ...
    def get_market_depth(self,post_data={}):
        ...
        post_data['params']=[post_data['limit'],self.tradeType]
        return self._private_request(post_data)

    def buy(self,price,amount,post_data={}):
        post_data['method']='buyOrder2'
        post_data['params']=[price,amount,self.tradeType]
        return self._private_request(post_data)
    ...
    def cancel(self,order_id,post_data={}):
        ...
        post_data['params']=[self.tradeType,order_id]
        return self._private_request(post_data)
